...
import { ChevronLeft, ThumbsUp, ThumbsDown, Share2, MessageCircle, ArrowRight } from "lucide-react";
  ...
  const getBreadcrumbs = () => {
    switch (article.category) {
      ...
      case "ספורט":
        return ["ראשי", "ספורט"];
      default:
        return ["ראשי", "חדשות", article.category];
    }
  };

  const breadcrumbs = getBreadcrumbs();

  // Filter out current article for recommendations
